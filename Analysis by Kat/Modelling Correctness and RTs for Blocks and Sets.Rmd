...
#DataSubset <- subset(DataNew, Block == "9")

#DataSubset <- subset(DataNew, Condition == "1"|Condition == "2"|Condition == "3A"||Condition == "3B"|Condition == "4"|Condition == "10"| Condition == "5"| 
                       #Condition == "6A"||Condition == "6B"|Condition == "7"|Condition == "8"|Condition == "9")

DataTraining <- subset(DataSubset, TrialType2 == "Training")

Model.Block.Training <- glmer(RespCorr ~ Block + Condition +
                          (1|ParticipantID),
                          data=DataTraining,
                          family= binomial)
...
DataNew$Condition <- as.factor(DataNew$Condition)
DataNew$Block <- as.factor(DataNew$Block)
DataNew$TrialType <- as.factor(DataNew$TrialType)
...
DataTesting <- subset(DataSubset, TrialType == "Training")

Model.Block.Testing <- glmer(RespCorr ~ Condition +
                          (1|ParticipantID),
                          data=DataTesting, 
                          family= binomial)
...
summary(glht(Model.Block.Testing, linfct = mcp(Condition = "Tukey")), test = adjusted("holm"))
```

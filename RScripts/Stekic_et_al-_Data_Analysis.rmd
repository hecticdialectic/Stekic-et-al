...
ExtremeData <- read.csv("C:/Users/775/Documents/GitHub/Stekic-et-al/Data/CleanData4.csv")
ExtremeData <- subset(ExtremeData, Condition == 10|Condition == "3A"|Condition == "3B")
...
#Curviness is not massively central to our replication, so lets drop it and see if we can get a model to converge

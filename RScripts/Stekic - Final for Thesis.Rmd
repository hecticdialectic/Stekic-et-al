...
write.csv(CleanData.Final, file=("C:/Users/Alank/Documents/GitHub/Stekic-et-al/Data/CleanDataFinal.csv"))
...
Part4Data <- rbind(Part2Data, Part3Data)
...
#FIRST 4 TRIALS
OmnibusEarly4 <- subset(Part4Data, TrialType == "Training" & TrialNum < 5)
...
#First 2 Trials
OmnibusEarly2 <- subset(Part4Data, TrialType == "Training" & TrialNum < 3)
...
#First 8 Trials
OmnibusEarly8 <- subset(Part4Data, TrialType == "Training" & TrialNum < 9)
...
Interference.RT <- summarySE(Part4Data, measurevar = "RT", groupvars = c("Iconicity"))
...
Interference.RT2 <- summarySE(subset(Part4Data, TrialType == "Training"), measurevar = "RT", groupvars = c("Iconicity"))
...
MeanTrial <- mean(CleanData.Final$RT) #Mean Trial Length

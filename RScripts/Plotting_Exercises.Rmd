...
moltenplay <- melt(PlayData, id.vars = "Name")

Race <- c("Chinese", "Chinese", "Japanese", "Caucasian", "Martian")
PlayData <- cbind (PlayData, Race)

moltenplay <- melt(PlayData, id.vars = c("Name", "Race"))
```

...
```{r CreateSample, warning = FALSE, message = FALSE}
...
##################################################################
```{r Create Stimlist, warning = FALSE, message = FALSE}
...
```{r Write Stimuli, warning = FALSE, message = FALSE}
writestimuli <- function(seeds, perseed, condition, subcondition) {  
  ...
  for (i in 1:seeds) {
    ...
    for (j in 1:perseed) {
      ...
      traininglist <- subset(stimlist, TrialType == "Training")

      write.table(traininglist, paste("C:/Users/Alan/Google Drive/Experiments/Collaborations/Stekic et al/Repo/data/stimlists/New/Training/",
                                  condition,"-", subcondition,"-", seednum, "-",
                                  seedval, "-", j, "-Training", ".csv", sep = ''),
                  sep = "\t", row.names = FALSE)
      
      #Write out the Testing Files
      testinglist <- subset(stimlist, TrialType == "Testing")
      write.table(testinglist, paste("C:/Users/Alan/Google Drive/Experiments/Collaborations/Stekic et al/Repo/data/stimlists/New/Testing/",
                                  condition,"-", subcondition,"-", seednum, "-",
                                  seedval, "-", j, ".csv", sep = ''),
                  sep = "\t", row.names = FALSE)
...
```{r Call Functions, warning = FALSE, message = FALSE}
ImageStims <- read.csv("C:/Users/Alan/Google Drive/Experiments/Collaborations/Stekic et al/Repo/Figures/ChosenImages.csv")
...
for(condition in conditions){
  for(subcondition in subconditions){
    writestimuli(2,5, condition, subcondition)
  }
}

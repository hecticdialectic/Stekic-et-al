...
writestimuli <- function(seeds, perseed, condition, subcondition) {  
  ...
  for (i in 1:seeds) {
    ...
    for (j in 1:perseed) {
      ...
      write.table(stimlist, paste("F:/GitHub Repos/Stekic-et-al/Data/Stimlists/Full/",
                                  condition,"-", subcondition,"-", seednum, "-",
                                  seedval, "-", j, "-", "Full", ".csv", sep = ''),
                  sep = "\t", row.names = FALSE)
      
      
      trainlist <- subset(stimlist, TrialType == "Training")
      testlist <- subset(stimlist, TrialType == "Testing")
      
      write.table(trainlist, paste("F:/GitHub Repos/Stekic-et-al/Data/Stimlists/Training/",
                                  condition,"-", subcondition,"-", seednum, "-",
                                  seedval, "-", j, "-",  "Training", ".csv", sep = ''),
                  sep = "\t", row.names = FALSE)
      
      write.table(testlist, paste("F:/GitHub Repos/Stekic-et-al/Data/Stimlists/Testing/",
                                  condition,"-", subcondition,"-", seednum, "-",
                                  seedval, "-", j,  ".csv", sep = ''),
                  sep = "\t", row.names = FALSE)    
...
ImageStims <- read.csv("F:/GitHub Repos/Stekic-et-al/Figures/ChosenImages.csv")

...
jsPsych.plugins['bio'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    $('.survey_display').html(
      "<p>Zamolili bismo Vas da odgovorite na još dva demografska pitanja.</p>"+
      "<div class='age'>"+
      "<label><p>Koliko godina imate?</p>"+
      "<input type='text' maxlength=2 class='numbersOnly' id='age_input'>"+
      "</input>"+
      "</label>"+
      "</div>"+
      "<div class='gender'><p>Koji je Vaš pol?</p>"+
      "<label class='bioRadio'>"+
      "<input type='radio' name='gender' class='gender' value='m'> Muški"+
      "</input>"+
      "</label>"+
      "<label class='bioRadio'>"+
      "<input type='radio' name='gender' class='gender' value='f'> Ženski"+
      "</input>"+
      "</label>"+
      "<label class='bioRadio'>"+
      "<input type='radio' name='gender' class='gender' value='o'> Drugi  "+
